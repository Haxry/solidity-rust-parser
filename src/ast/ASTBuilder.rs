...
// #[derive(Debug)]
// pub struct WithMeta {
//     _with_meta: std::marker::PhantomData<()>, // Marker type, does not hold value
// }


// #[derive(Debug)]
// pub struct ASTBuilderNode {
//     pub ast_node: AST::ASTNode,  // Include the ASTNode
//     pub with_meta: WithMeta, // Include the WithMeta marker
// }

// pub struct ASTBuilder<'input> {
//     pub result: Option<AST::SourceUnit>,
...
//     fn default_result(&self) -> ASTBuilderNode {
//         panic!("Unknown node");
//     }

//     fn aggregate_result(&self) -> ASTBuilderNode {
//         // ASTBuilderNode {
